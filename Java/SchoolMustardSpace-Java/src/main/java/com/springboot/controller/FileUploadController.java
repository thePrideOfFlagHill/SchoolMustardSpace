...
public class FileUploadController {
    ...
    @ResponseBody
    public ResponseResult setTaskFilesUpload(@RequestParam(value = "files") MultipartFile file,
                                            @RequestParam(value = "id") String id) {
    ...
    @ResponseBody
    public ResponseResult setGoodFilesUpload(@RequestParam(value = "file") MultipartFile file,
                                            @RequestParam(value = "id") String id) {
    ...
    @ResponseBody
    public ResponseResult setLostFoundFilesUpload(@RequestParam(value = "file") MultipartFile file,
                                                 @RequestParam(value = "id") String id) {
